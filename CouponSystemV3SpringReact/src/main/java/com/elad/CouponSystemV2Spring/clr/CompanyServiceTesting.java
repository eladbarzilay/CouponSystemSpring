	...
	public void run(String... args) throws Exception {
		...
		companyService.setCompanyId(2);
			...
			Coupon c2 = Coupon.builder()
					...
					.endDate(DateUtills.getDate(19, 6, 2021))
					.price(51.99)
					.amount(9)
					.image("not availabale")
					.build();
			Coupon c3 = Coupon.builder()
					...
					.endDate(DateUtills.getDate(9, 9, 2021))
					.price(150.99)
					.amount(0)
			...
			Coupon c5 = Coupon.builder()
					...
					.endDate(DateUtills.getDate(26, 6, 2021))
					.price(10.99)
					.amount(6)
					.image("not availabale")
					.build();
			Coupon c6 = Coupon.builder()
					...
					.endDate(DateUtills.getDate(25, 1, 2021))
					.amount(2)
					.price(22.50)
					.image("not availabale").build();
			...
			companyService.addCompanyCoupon(c1);
			companyService.addCompanyCoupon(c2);
			System.out.println();
