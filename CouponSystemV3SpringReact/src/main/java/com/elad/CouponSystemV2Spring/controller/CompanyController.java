...
import com.elad.CouponSystemV2Spring.service.CompanyService;
...
public class CompanyController{
	...
	public void addCompanyCoupon(@RequestHeader(value = "Authorization") String token, @RequestBody Coupon coupon) {
		companySeviceImpl.setCompanyId(2);
		companySeviceImpl = (CompanyServiceImpl) tokenManager.getService(token);
		companySeviceImpl.addCompanyCoupon(coupon);
	}
